...
experimental_properties <- drug$AddChild("Experimental Properties")
...
targets_references_articles <- targets_references$AddChild("Articles")
...
targets_polypeptides_external_identifiers <- targets_polypeptides$AddChild("External Identifiers")
targets_polypeptides_go_classifiers <- targets_polypeptides$AddChild("GO Classifiers")
targets_polypeptides_pfams <- targets_polypeptides$AddChild("PFAMS")
targets_polypeptides_synonyms <- targets_polypeptides$AddChild("Synonyms")

enzymes <- drug$AddChild("Enzymes")
enzymes_actions <- enzymes$AddChild("Actions")
enzymes_references <- enzymes$AddChild("References")
enzymes_references_articles <- enzymes_references$AddChild("Articles")
...
enzymes_polypeptides_external_identifiers <- enzymes_polypeptides$AddChild("External Identifiers")
enzymes_polypeptides_go_classifiers <- enzymes_polypeptides$AddChild("GO Classifiers")
enzymes_polypeptides_pfams <- enzymes_polypeptides$AddChild("PFAMS")
enzymes_polypeptides_synonyms <- enzymes_polypeptides$AddChild("Synonyms")
...
carriers_references_articles <- carriers_references$AddChild("Articles")
...
carriers_polypeptides_external_identifiers <- carriers_polypeptides$AddChild("External Identifiers")
carriers_polypeptides_go_classifiers <- carriers_polypeptides$AddChild("GO Classifiers")
carriers_polypeptides_pfams <- carriers_polypeptides$AddChild("PFAMS")
carriers_polypeptides_synonyms <- carriers_polypeptides$AddChild("Synonyms")
...
transporters_references_articles <- transporters_references$AddChild("Articles")
transporters_references_books <- transporters_references$AddChild("Books")
transporters_references_links <- transporters_references$AddChild("Links")
transporters_polypeptides <- transporters$AddChild("Polypeptides")
transporters_polypeptides_external_identifiers <- transporters_polypeptides$AddChild("External Identifiers")
transporters_polypeptides_go_classifiers <- transporters_polypeptides$AddChild("GO Classifiers")
transporters_polypeptides_pfams <- transporters_polypeptides$AddChild("PFAMS")
transporters_polypeptides_synonyms <-transporters_polypeptides$AddChild("Synonyms")
